...
//        web.getSettings().setBlockNetworkImage(true);
        ...
        web.addJavascriptInterface(InJavaScriptLocalObj(), "local_obj")
...
//                info { "measuredHeight2:$measuredHeight" }
    ...
    fun resize(height: Int) {
        ...
        (this as Context).runOnUiThread {
            ...
            params.height = (height * getResources().getDisplayMetrics().density).toInt();
            web.requestLayout();
        }
    }
    ...
    internal class InJavaScriptLocalObj {
